...
vector<double> energyCorrections(int Z, int n1, int l1, bool s1, int n2, int l2, bool s2)
{
    ...
    DiracAtom da_sphere = DiracAtom(Z, Physical::m_mu, getElementMainIsotope(Z), SPHERE);
    DiracAtom da_uehling = DiracAtom(Z, Physical::m_mu, getElementMainIsotope(Z), SPHERE);
